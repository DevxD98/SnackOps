...
class ChefByteAgent:
    """
    Main orchestrator for the ChefByte AI agent
    ...
    def _generate_final_plan(self, meal_count):
        ...
        prompt = f"""
You are ChefByte, an AI meal planning assistant. Based on the following information, 
...
def main():
    ...
    # Example run without images (using mock data)
    # To use real images, replace None with actual image paths
    result = agent.run(
        fridge_image=None,  # Use: "path/to/fridge.jpg" for real images

...
def create_meal_plan(fridge_image, receipt_image, dietary_constraints, calorie_target, meal_count):
    ...
    try:
        ...
        # Format output
        output = "# 🍽️ Your PantryPilot Meal Plan\n\n"
        output += "---\n\n"
...
def create_ui():
    ...
    Returns:
        Gradio Blocks app
    """
    with gr.Blocks(title="PantryPilot 🍳", theme=gr.themes.Soft()) as app:
        gr.Markdown(
            """
            # 🍳 PantryPilot - AI Meal Planning Agent
...
def main():
    ...
    print("\n" + "="*50)
    print("🍳 Starting PantryPilot Gradio UI...")
    print("="*50 + "\n")
